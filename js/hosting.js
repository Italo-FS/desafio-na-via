...
function lasticecandidate() {
	...
	document.querySelector('.token__loading').classList.add("invisible");
	document.querySelector('.token__content').classList.remove('invisible');
	document.querySelector('.mode__button_p2p_copy').classList.remove('invisible');
}
...
function copyToken() {
	var text = document.getElementById("textoffer").value;
